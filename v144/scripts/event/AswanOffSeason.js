...
function allMonstersDead(eim) {
    ...
    //eim.broadcastPlayerMsg(6, "[Hilla's Gang Liberation] Enter the portal to claim your reward!");
        ...
        eim.broadcastPacket(WvsContext.enableActions());
    }
    if (curstage > 3) {
        eim.broadcastPacket(CPacket.showEffect("aswan/stageEff/final"));
    } else {
        eim.broadcastPacket(CPacket.showEffect("aswan/stageEff/stage"));
        eim.broadcastPacket(CPacket.showEffect("aswan/stageEff/number/" + curstage));
    }
