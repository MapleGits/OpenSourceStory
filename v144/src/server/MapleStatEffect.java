        ...
        if (ret.skill) {
            switch (sourceid) {
                ...
                case 22161004:
                    ...
                    break;
                case 13111023:
                    ret.statups.put(MapleBuffStat.ALBA1, level);
                    ret.statups.put(MapleBuffStat.ALBA2, ret.info.get(MapleStatInfo.indiePad));
                    ret.statups.put(MapleBuffStat.ALBA3, ret.info.get(MapleStatInfo.indieMhp));
                    ret.statups.put(MapleBuffStat.ALBA4, ret.info.get(MapleStatInfo.indieBooster));
                    ret.statups.put(MapleBuffStat.ALBA5, ret.info.get(MapleStatInfo.indieCr));
                ...
                case 36121003:
                    ret.statups.put(MapleBuffStat.PERCENT_DAMAGE_BUFF, ret.info.get(MapleStatInfo.indieDamR));
                    ret.statups.put(MapleBuffStat.BOSS_ATTDMG, ret.info.get(MapleStatInfo.x));
                    break;
                case 36121004:
                ...
                case 27121054:
                    ...
                    break;
                case 27121005:
                    ret.statups.put(MapleBuffStat.Dark_Crescendo, Integer.valueOf(1));
                    break;
                case 27121006:
                    ret.statups.put(MapleBuffStat.Ignore_resistances, Integer.valueOf(-((Integer) ret.info.get(MapleStatInfo.x)).intValue()));
                    ret.statups.put(MapleBuffStat.Ignore_DEF, Integer.valueOf(-((Integer) ret.info.get(MapleStatInfo.y)).intValue()));
                    break;
                case 41001001:
                    ret.info.put(MapleStatInfo.time, Integer.valueOf(2100000000));
...
//            }
    ...
    public final void applyMonsterBuff(MapleCharacter applyfrom) {
        System.out.println("start applymonsterbuff on maplestateffect");
        Rectangle bounds = calculateBoundingBox(applyfrom.getTruePosition(), applyfrom.isFacingLeft());
...
//            }
    ...
    public final boolean isHide() {
        return this.skill && (sourceid == 9101002);
    }
    ...
    public final int getMPPerLevel() {
