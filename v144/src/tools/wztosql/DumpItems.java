    ...
    public void dumpItems() throws Exception {
        if (!hadError) {
            ...
            try {
                ...
                psr.executeBatch();
                psr.close();
                System.out.println("Dumped " + psr.toString());
                psa.executeBatch();
                psa.close();
                System.out.println("Dumped " + psa.toString());
                ps.executeBatch();
                ps.close();
                System.out.println("Dumped " + ps.toString());
                pse.executeBatch();
                pse.close();
                System.out.println("Dumped " + pse.toString());
