...
public class SkillFactory {
    ...
    public static void load() {
        MapleData delayData = MapleDataProviderFactory.getDataProvider(new File("wz/Character.wz")).getData("00002000.img");
        MapleData stringData = MapleDataProviderFactory.getDataProvider(new File("wz/String.wz")).getData("Skill.img");
        MapleDataProvider datasource = MapleDataProviderFactory.getDataProvider(new File("wz/Skill.wz"));
    ...
    public static Skill getSkill(int id) {
        if (!skills.isEmpty()) {
            if ((id >= 92000000 && id <= 100000000) && (crafts.containsKey(Integer.valueOf(id)))) {
