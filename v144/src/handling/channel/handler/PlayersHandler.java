...
public class PlayersHandler {
    ...
    public static final void AttackPVP(LittleEndianAccessor slea, MapleClient c) {
        ...
        if ((chr == null) || (chr.isHidden()) || (!chr.isAlive()) || (chr.hasBlockedInventory()) || (chr.getMap() == null) || (!chr.inPVP()) || (!chr.getEventInstance().getProperty("started").equals("1")) || (skillid >= 90000000 && skillid <= 100000000)) {
            c.getSession().write(CWvsContext.enableActions());
            return;
        }
