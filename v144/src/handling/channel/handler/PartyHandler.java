...
//        if ((action == 0x23) && (GameConstants.GMS)) {
            ...
            if (party != null) {
                ...
                if (action == 0x23) {
                    if (party.getMembers().size() < 6) {
                        ...
                        c.getPlayer().dropMessage(5, "The party you are trying to join is full.");
                    }
                } else if (action != 0x1F) {
                    MapleCharacter cfrom = c.getChannelServer().getPlayerStorage().getCharacterById(party.getLeader().getId());
                    if (cfrom != null) {
                        cfrom.getClient().getSession().write(CWvsContext.serverNotice(5, c.getPlayer().getName() + " has joined the party."));
                    }
                }
            } else {
                ...
                if (party == null) {
                    ...
                    if (party != null) {
                        ...
                        if ((party.getMembers().size() < 6) && (c.getPlayer().getQuestNoAdd(MapleQuest.getInstance(122901)) == null)) {
                            ...
                            c.getPlayer().dropMessage(5, "Party is full.");
                        }
                    } else {
                        c.getPlayer().dropMessage(5, "The party you are trying to join does not exist");
                    }
            ...
            case 4:
                ...
                if (theCh > 0) {
                    ...
                    if ((invited != null) && (invited.getParty() == null) && (invited.getQuestNoAdd(MapleQuest.getInstance(122901)) == null)) {
                        ...
                        c.getPlayer().dropMessage(5, "Already in a party.");
                    }
                } else {
                    c.getPlayer().dropMessage(5, "Player doesn't exist.");
                }
                break;
            case 5:
