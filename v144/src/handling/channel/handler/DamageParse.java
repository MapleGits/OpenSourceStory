...
public class DamageParse {
        ...
        for (AttackPair oned : attack.allDamage) {
            ...
            for (AttackPair at : attack.allDamage) {
                ...
                if ((totDamageToOneMonster > 0) || (attack.skill == 1221011) || (attack.skill == 21120006)) {
                    ...
                    int randomDMG = 0;
                    if (GameConstants.demon_AV(player.getJob())) {
    ...
    public static final double ElementalStaffAttackBonus(Element elem, double elemMaxDamagePerMob, PlayerStats stats) {
        switch (elem) {
            case FIRE:
