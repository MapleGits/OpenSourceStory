...
public enum SendPacketOpcode {
    ...
    SHOW_SCROLL_EFFECT((short) 0x16C),//14b
    SHOW_MAGNIFYING_EFFECT((short) 0x16D),//14c
    ...
    TESLA_TRIANGLE((short) 0x17D),//0x15C
    ...
    UPDATE_QUEST_INFO((short) 0x1F0),//1C8
    ...
    BUFF_ZONE_EFFECT((short) 0x209),//1E2
    ...
    AP_SP_EVENT((short) 0x210),//1E9
    QUEST_GUIDE_NPC((short) 0x211),//1EA
    ...
    MTS_OPERATION((short) 0x7EFFF), 
    GET_MTS_TOKENS((short) 0x7EFFF), 
    MTS_OPEN((short) 0x7EFFF), 
    //CS_USE1((short) 0x999),
    RESPAWN_FAMILIAR((short) 0x7EFFF);    
